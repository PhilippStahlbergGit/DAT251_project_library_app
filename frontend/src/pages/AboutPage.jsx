    ...
    <section className="about-page">
      ...
      <div className="about-cards">
        ...
        <div className="about-card">
          <h2>Peer Loans</h2>
          <p>
            Lend books from your library to other users. Each loan tracks the
            due date and return date, and the book's availability status is
      ...
      <div className="about-tech">
        <h2>Tech Stack</h2>
        <ul>
          <li><strong>Backend:</strong> Spring Boot 3, Spring Security, JPA / Hibernate, H2 (dev)</li>
          <li><strong>Auth:</strong> JWT with token blacklisting</li>
          <li><strong>Frontend:</strong> React 18, React Router v6, Context API</li>
          <li><strong>Build:</strong> Maven · Vite</li>
        </ul>
      </div>
    </section>
  );
